...
public class StepDetectionDemoGravity extends Activity {
	...
	private Sensor getSensor(int sensorType, String sensorName) {
		...
		if (sensor != null) {
			...
			Toast.makeText(StepDetectionDemoGravity.this, sensorName+" found", Toast.LENGTH_SHORT).show();
		} else {
			Toast.makeText(StepDetectionDemoGravity.this, "there is no " + sensorName, Toast.LENGTH_SHORT).show();
	...
	private class GraphView extends View implements SensorEventListener {
		...
		public GraphView(Context context) {
			...
			double powerCutoff = StepDetectorGravity.POWER_CUTOFF_VALUE;
			if (prefs != null) {
				try {
		...
		private void displayStepDetectorState(
				StepDetectorGravityState state) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAccelerometer = getSensor(Sensor.TYPE_GRAVITY, "linear acceleration sensor");
